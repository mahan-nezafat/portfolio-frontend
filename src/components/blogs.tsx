    ...
    return (
        <>
            <div className="flex w-full justify-between items-center mt-10">
                <h1 className="pr-10 pt-3 text-5xl bg-clip-text text-transparent bg-gradient-to-b to-gray-800 font-[iranbakhbold] from-[#FFFFFF]">
                    بلاگ
                </h1>
                <Link
                    href="/projects"
            ...
            <div className="py-10 px-10 max-md:px-5 flex justify-around items-center mb-12 ">
                <div className="max-md:w-full w-full max-lg:w-[40%] max-xl:w-[30%] max-2xl:w-[30%] min-2xl:w-[23%]   flex flex-col justify-between items-center hover:translate-y-[-6px] transition-all duration-300 ease-in-out rounded h-110 shadow-md shadow-blue-900">
